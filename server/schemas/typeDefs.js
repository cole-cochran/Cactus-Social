...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        removeTechnology(technology: String!): User
        addFriend(username: String!, friend: String!): User
        removeFriend(username: String!, friend: String!): User
        ...
        removeThread(userId: ID!, threadId: ID!): User
        ...
        pinPost(thread: String!, postId: ID!): Thread
