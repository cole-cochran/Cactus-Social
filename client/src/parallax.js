!(function (t) {
  function n(t) {
    ...
    if ("none" !== r) {
      var e = r.split("(")[1].split(")")[0].split(","),
        ...
        i = 0;
      16 == e.length
        ? ((o = parseFloat(e[e.length - 4])),
          (a = parseFloat(e[e.length - 3])),
          (i = parseFloat(e[e.length - 2])))
        : ((o = parseFloat(e[e.length - 2])),
          ...
          (h = g[b]),
            d && !h.background
              ...
              : ((y = h.startX + h.inversionFactor * (h.xRange * F)),
                ...
                h.background
                  ? h.obj.css({ "background-position": y + "px " + w + "px" })
                  : h.obj.css({ left: y, top: w }));
      }
    }
  }
  var i = 25,
  ...
  var d = (function () {
    ...
    for (var e in r)
      void 0 !== n.style[e] &&
        ((n.style[e] = "translate3d(1px,1px,1px)"),
        (t = window.getComputedStyle(n).getPropertyValue(r[e])));
    return (
      document.body.removeChild(n), void 0 !== t && t.length > 0 && "none" !== t
    );
  })();
